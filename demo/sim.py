...
class PyBulletSim:
    ...
    def __init__(self, use_random_objects=False, object_shapes=None, gui=True):
        ...
        self.robot_goal_joint_config = np.array([
            0, -np.pi/2, np.pi/8, -np.pi/4, -np.pi/2, 0])
        ...
        self.obstacles = [
            p.loadURDF('assets/obstacles/block.urdf',
                       basePosition=[0, 0.4, 0.8],
                       useFixedBase=True
                       ),
            p.loadURDF('assets/obstacles/block.urdf',
                       basePosition=[0, 0.5, 0.7],
                       useFixedBase=True
                       ),
            p.loadURDF('assets/obstacles/block.urdf',
                       basePosition=[0, 0.6, 0.6],
                       useFixedBase=True
                       ),
            p.loadURDF('assets/obstacles/block.urdf',
                       basePosition=[0, 0.7, 0.5],
                       useFixedBase=True
                       ),
            p.loadURDF('assets/obstacles/block.urdf',
                       basePosition=[0, 0.8, 0.4],
                       useFixedBase=True
                       ),
            p.loadURDF('assets/obstacles/block.urdf',
                       basePosition=[0, 0.9, 0.3],
                       useFixedBase=True
                       ),
            p.loadURDF('assets/obstacles/block.urdf',
                       basePosition=[0, -0.95, 0.9],
                       useFixedBase=True
                       ),
            p.loadURDF('assets/obstacles/block.urdf',
                       basePosition=[0, -0.95, 0.3],
                       useFixedBase=True
                       ),
            p.loadURDF('assets/obstacles/block.urdf',
    ...
    def get_robot_body_id(self):
        return self.robot_body_id
